...
export const metadata: Metadata = {
  title: "Syarat & Ketentuan — Catatuang",
  description: "Syarat dan ketentuan penggunaan aplikasi Catatuang.",
};
      ...
      <main className="flex-1 mx-auto w-full max-w-2xl px-6 py-16">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
          <section className="space-y-3">
            ...
            <p>
              Dengan mengakses dan menggunakan Catatuang, kamu menyatakan telah membaca, memahami, dan menyetujui syarat dan ketentuan ini. Jika tidak setuju, harap hentikan penggunaan layanan.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Catatuang adalah aplikasi pencatat keuangan pribadi berbasis AI yang memungkinkan pengguna mencatat transaksi menggunakan bahasa alami. Data disinkronkan ke Google Sheets milik pengguna. Layanan ini disediakan oleh{" "}
          ...
          <section className="space-y-3">
            ...
            <p>Untuk menggunakan Catatuang, kamu perlu login dengan akun Google. Kamu bertanggung jawab untuk:</p>
          ...
          <section className="space-y-3">
            ...
            <p>Kamu diperbolehkan menggunakan Catatuang untuk:</p>
            <ul className="list-disc list-inside space-y-2 pl-2">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc list-inside space-y-2 pl-2">
              ...
              <li>Mencoba meretas, memanipulasi, atau mengganggu sistem Catatuang.</li>
          ...
          <section className="space-y-3">
            ...
            <p>
              Data transaksi yang kamu input adalah <span className="text-foreground font-medium">milikmu sepenuhnya</span>. Catatuang hanya memproses data tersebut untuk menjalankan layanan. Kamu dapat mengekspor atau menghapus datamu kapan saja melalui Google Sheets yang terhubung.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Kami berusaha menjaga layanan tetap aktif 24/7, namun tidak menjamin ketersediaan tanpa gangguan. Catatuang berhak melakukan pemeliharaan, pembaruan, atau penghentian layanan sewaktu-waktu dengan atau tanpa pemberitahuan sebelumnya.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Catatuang disediakan "sebagaimana adanya" (<em>as-is</em>). Kami tidak bertanggung jawab atas kerugian finansial yang timbul akibat keputusan yang dibuat berdasarkan data atau analisis dari aplikasi ini. Gunakan sebagai alat bantu, bukan sebagai satu-satunya sumber keputusan keuangan.
            </p>
          </section>
