...
export default function ContactPage() {
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main id="main-content" className="mx-auto flex-1 w-full max-w-3xl px-4 sm:px-6 py-10 sm:py-16">
        ...
        <div className="grid gap-6 md:grid-cols-[1fr_0.85fr]">
          <section className="rounded-[28px] border border-border bg-card p-5 sm:p-8 shadow-sm">
            <h2 className="text-lg sm:text-xl font-semibold text-foreground">Email utama</h2>
            ...
            <a href="mailto:akbar.rm10@gmail.com" className="mt-6 inline-flex w-full sm:w-auto justify-center rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90">
              akbar.rm10@gmail.com
            </a>
          </section>

          <section className="rounded-[28px] border border-border bg-muted/35 p-5 sm:p-8">
            <h2 className="text-lg sm:text-xl font-semibold text-foreground">Topik yang bisa dibantu</h2>
        ...
        <section className="mt-10 rounded-[28px] border border-border bg-card p-5 sm:p-8 text-sm leading-relaxed text-muted-foreground shadow-sm">
          <h2 className="text-lg sm:text-xl font-semibold text-foreground">Permintaan data dan privasi</h2>
          <p className="mt-3">
          ...
          <div className="mt-6 flex flex-col sm:flex-row flex-wrap gap-3">
            <Link href="/privacy" className="w-full sm:w-auto text-center rounded-full border border-border px-5 py-2.5 text-sm font-semibold text-foreground transition-colors hover:bg-muted">
              Baca Kebijakan Privasi
            </Link>
            <Link href="/terms" className="w-full sm:w-auto text-center rounded-full border border-border px-5 py-2.5 text-sm font-semibold text-foreground transition-colors hover:bg-muted">
